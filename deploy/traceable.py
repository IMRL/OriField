...
def patch_builtin_len(modules=()):
    ...
    with ExitStack() as stack:
        ...
        # ] + list(modules) # raise NotImplementedError
...
def flatten_to_tuple(obj):
    ...
    schemas = [
        ...
        # (Instances, InstancesSchema),  # raise NotImplementedError
        # ((Boxes, ROIMasks), TensorWrapSchema),  # raise NotImplementedError
    ]
...
def dump_torchscript_IR(model, dir):
    ...
    with open(os.path.join(dir, "model_ts_code.txt"), "w") as f:
