...
class RawDerivedSemanticKitti(pc_processor.dataset.semantic_kitti.SemanticKitti):
    def __init__(self,
                 panoptic,
                 ...
                 has_pcd=True,
                 has_label=True):
        super(RawDerivedSemanticKitti, self).__init__(root=root, sequences=sequences, config_path=config_path, has_image=has_image, has_pcd=has_pcd, has_label=has_label)
